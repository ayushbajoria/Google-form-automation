...
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//textarea")));
        ...
        WebElement nameInputBox = new WebDriverWait(driver, Duration.ofSeconds(10))
        ...
        WebElement practicingAutomationTextArea = driver.findElement(
                By.xpath("//textarea[contains(@class, 'tL9Q4c')]"));
        ...
        WebElement dropDoWebElement = driver.findElement(
        ...
        WebElement dateInputBox = driver.findElement(
                By.xpath("//div[contains(@class,'A6uyJd')]//input"));
        ...
        WebElement successMsgElement = driver.findElement(
                By.xpath("//div[contains(@class,'vHW')]"));
